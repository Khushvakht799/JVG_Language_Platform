...
from preference import PreferenceProfile, get_preference_vector
from metrics import MetricsCollector, update_ranking_metrics
...
class JVGRankingEngine:
    ...
    def search(self, query: str, filters: Dict[str, Any] = None, top_k: int = 10, profile: PreferenceProfile = None) -> List[Dict[str, Any]]:
        results_by_doc = {}
        for layer_name, layer_info in self.layers.items():
            collection = self.client.get_collection(layer_info["collection"])
